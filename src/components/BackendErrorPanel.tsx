...
export function BackendErrorPanel({ error, onRetry, onSwitchToDev }: BackendErrorPanelProps) {
  // 检测是否是 JSON 解析错误（通常意味着后端没运行）
  const isBackendDown = error.includes('JSON') || error.includes('HTML');
    ...
    <div className="p-6 bg-destructive/5 border-2 border-destructive/20 rounded-lg">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 space-y-4">
          <div>
            <h3 className="font-bold text-destructive mb-2">无法连接到后端服务器</h3>
          ...
          {isBackendDown && (
            <div className="bg-card border border-border rounded p-4 space-y-3">
              <div className="flex items-center gap-2 text-primary">
                ...
                <span className="font-semibold text-sm">快速解决方案</span>
              </div>
              ...
              <div className="space-y-2 text-xs">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <span className="font-semibold">启动后端服务器：</span>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <span className="font-semibold">验证后端运行：</span>
                    <a 
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <span className="font-semibold">点击下方"重试"按钮</span>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-2 border-t border-border/50">
                <p className="text-[10px] text-muted-foreground">
                  💡 <span className="font-semibold">或者</span>，如果暂时不需要后端，可以切换到开发模式使用 Mock 数据继续开发
                </p>
              </div>
            </div>
          )}
