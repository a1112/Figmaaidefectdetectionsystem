...
export const SettingsPage: React.FC<SettingsPageProps> = ({ theme, setTheme }) => {
  const [apiProfile, setApiProfile] = useState<ApiProfile>(env.getApiProfile());
  ...
  const handleApiProfileChange = (profile: ApiProfile) => {
    ...
    if (confirm('切换图像服务器模式后需要刷新页面，是否立即刷新？')) {
        ...
        {mode === 'production' && (
          <div className="bg-card border border-border rounded-lg p-4 space-y-3">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-sm font-medium">IMAGE SERVER / 图像模式</div>
            ...
            <div className="flex gap-2 mt-2">
              <button
                onClick={() => handleApiProfileChange('default')}
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-[10px] opacity-70">16K 数据 / 原始 2D</div>
                  </div>
                </div>
              </button>
              <button
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <div className="text-left">
                    <div className="text-xs font-semibold">SMALL</div>
                    <div className="text-[10px] opacity-70">8K 数据 / 精简图像</div>
                  </div>
                </div>
              </button>
            </div>
